"""Day 5 Benchmark: Clipping and Measurement Performance Validation.
...
if __name__ == '__main__':
    print("=" * 70)
    print("Day 5 Benchmark: Clipping Pipeline Performance")
    print("=" * 70)
    
    print(f"\n{'Points':>10} | {'Selected':>10} | {'Selectivity':>11} | {'Mask (ms)':>9} | {'Apply (ms)':>10} | {'Total (ms)':>10} | {'P95 Total':>10}")
    print("-" * 85)
    ...
    print("\n" + "=" * 70)
    print("Day 5 Benchmark: KD-Tree Build + Snap-to-Point")
    print("=" * 70)
    ...
    print("\n" + "=" * 70)
    print("Day 5 Benchmark: Measurement Cleanup on Clip Change")
    print("=" * 70)
